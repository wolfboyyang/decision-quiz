...
export const QUIZ_DATA: {
  ...
  {
    id: 3,
    title: "Varčevanje ali poraba?",
    image: imageModules["/src/lib/assets/icons/3.png"].default,
    scenario:
      "Za rojstni dan si od sorodnikov dobil/a 40 €. Tvoj dolgoročni cilj je nakup novih slušalk, ki stanejo 80 €. Hkrati pa te prijatelji vabijo na pijačo in v kino, kar bi te stalo 15 €. Kaj storiš? ",
    options: {
      A: "Vseh 40 € takoj dodam k prihrankom za slušalke. Bližje bom cilju!",
      B: "Grem s prijatelji v kino in na pijačo (porabim 15 €), preostalih 25 € pa dam na stran za slušalke.",
      C: "Pozabim na slušalke in si s celotnim zneskom privoščim nekaj lepega takoj – kino, pijačo in še novo majico.",
    },
    feedback: {
      ...
      C: "Uživanje v sedanjosti je pomembno, a ta odločitev te oddalji od tvojega dolgoročnega cilja – slušalk. Upravljanje z denarjem pomeni iskanje ravnovesja med trenutnimi željami in prihodnjimi potrebami.",
    },
  },
  {
    id: 4,
    ...
    scenario:
      "Po nesreči ti je telefon padel na tla in zaslon je počil. Telefon še vedno deluje, a razpoka je moteča, zato si želiš novega telefona. Kaj storiš? ",
    options: {
      A: "Vztrajam pri starših, da potrebujem nov telefon, ker je ta uničen in me je sram pred prijatelji.",
      B: "Uporabljam telefon s počenim zaslonom in začnem varčevati, da si ga bom nekoč zamenjal/a.",
      C: "Preverim, koliko stane popravilo zaslona. Denar za popravilo poskusim zaslužiti z dodatnim delom ali pa ga pokrijem iz svojih prihrankov.",
    },
    feedback: {
  ...
  },
  {
    ...
    options: {
      ...
      B: "Vprašam starše za dovoljenje za nakup in jim ponudim, da jim znesek vrnem od svoje žepnine.",
  ...
  },
  {
    ...
    scenario:
      "Cel mesec si varčeval/a in imaš končno 20 € za novo majico, ki si jo želiš. V šoli pa ravno ta teden zbirajo prostovoljne prispevke za sošolca, čigar družina se je znašla v stiski.",
    options: {
      A: "Denar je moj in trdo sem varčeval/a zanj. Kupim si majico.",
      B: "Odpovem se majici in celoten znesek (20 €) darujem za sošolca.",
      C: "Naredim kompromis: za sošolca darujem del denarja (npr. 5 ali 10 €), preostanek pa še naprej hranim za majico.",
    },
    feedback: {
      A: "Pravico imaš do svojega denarja in do uresničevanja svojih ciljev. To je pomemben del finančne samostojnosti. Včasih pa nam življenje ponudi priložnost, da razmislimo tudi o potrebah drugih.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Naredim hitro, in če se bo sosed pritožil, bom pa popravil/a.",
    },
    feedback: {
      A: "Res je, da bi tako prihranil/a čas, a vprašaj se, ali je to pošteno do soseda, ki ti je zaupal delo. Slaba storitev lahko uniči tvoj ugled in prihodnje priložnosti za zaslužek. To je vprašanje delovne etike.",
  ...
  },
  {
    ...
    scenario:
      "Potrebuješ nov šolski nahrbtnik. Starši so ti namenili 70 €. V trgovini vidiš dva: enega zelo priljubljene znamke za 70 € in drugega, zelo podobnega in enako kakovostnega, neznane znamke za 40 €.",
    options: {
